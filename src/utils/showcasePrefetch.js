...
const PRIORITY_FILES = [
  'Slate — One card. Every currency. Zero friction..png',
  'Aura — This Card is Soul.png',
  'Heritage.png',
  'Atlas AI — One API for every AI model.png',
  'D5 — Velour (13).png',
  'D9 — Axis Talent Agency.png',
  'D11 — Bloom Roastery · Studio.png',
  'Edge of Light.png',
]

const REMAINING_FILES = [
  'Kairo Maye — Sports Editorial.png',
  'Nova — Generate Stunning AI Images.png',
  'Pulse — Sound Meets Soul.png',
  'Silentship.png',
  'haus — The Rebirth of Real Estate.png',
  'A-News — Train. Recover. Repeat..png',
  'Body.png',
  'D10 — Nia Obi · Web Designer · Art Director.png',
  'D2 — Fold Atelier.png',
  'D3 — Maren Studio · Voss portfolio.png',
  'D4 — Sato ® · Photography.png',
  'D6 — Meridian Atelier · Perfume essay.png',
  'D8 - Crumb - Bakery and Cafe.png',
  'Device Mockup By Soni Labs3.png',
  'Hero.png',
  'Vision Board.png',
